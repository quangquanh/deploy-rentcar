...
class ForgotPasswordController extends Controller
{
    ...
    public function showForgotForm()
    {
        ...
        return view('user.auth.forgot-password',compact('page_title','auth'));
    }
    public function showOtpVerificationForm()
    {
        $page_title = setPageTitle(__("OTP Verification"));
    ...
    public function sendCode(Request $request)
    {
        ...
        if(!$user) {
            throw ValidationException::withMessages([
                'credentials'       => __("Oops! User doesn't exists."),
            ]);
        }
    ...
    public function showResetForm($token) {
        $page_title = setPageTitle(__("Reset Password"));
    ...
    public function resetPassword(Request $request,$token) {
        ...
        return redirect()->route('frontend.index')->with(['success' => [__('Password reset success. Please login with new password.')]]);
    }
}
