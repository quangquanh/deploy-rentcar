...
<!-- jquery -->
<script src="{{ asset('public../resources/installer/src/assets/js/jquery-3.6.0.min.js') }}"></script>
<!-- bootstrap js -->
<script src="{{ asset('public../resources/installer/src/assets/js/bootstrap.bundle.min.js') }}"></script>
<!-- smooth scroll js -->
<script src="{{ asset('public../resources/installer/src/assets/js/smoothscroll.min.js') }}"></script>
<!-- lightcase js-->
<script src="{{ asset('public../resources/installer/src/assets/js/lightcase.js') }}"></script>
<!-- main -->
<script src="{{ asset('public../resources/installer/src/assets/js/main.js') }}"></script>
