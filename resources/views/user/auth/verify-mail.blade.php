            ...
            <div class=" col-xl-6 col-lg-8 col-md-10 col-sm-12">
                <div class="verification-otp-area">
                    <div class="account-wrapper otp-verification">
                        ...
                        <form class="account-form pt-20" action="{{ setRoute('user.authorize.mail.verify',$token) }}" method="POST">
                            @csrf
                            <div class="row ml-b-20">
                                ...
                                <div class="col-lg-12 text-center">
                                    <div class="account-item">
                                        <label>{{ __("Back to") }} <a href="{{ setRoute('frontend.redirect.logout') }}" class="text--base" data-block="login">{{__("Home")}}</a></label>
                                    </div>
                                </div>
                            </div>
                        </form>
