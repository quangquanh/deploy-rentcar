...
@section('content')
        ...
        <div class="table-wrapper">
            <div class="table-header justify-content-end">
                <div class="table-btn-area">
                    <a href="#serviceItem-add" class="btn--base modal-btn"><i class="fas fa-plus me-1"></i> {{ __("Add Service Item") }}</a>
                </div>
            </div>
    ...
    <div id="serviceItem-edit" class="mfp-hide large">
...
<script>
    openModalWhenError("serviceItem-add","#serviceItem-add");
    openModalWhenError("serviceItem-edit","#serviceItem-edit");
    ...
    $(".edit-modal-button").click(function(){
        ...
        var editModal = $("#serviceItem-edit");
        ...
        openModalBySelector("#serviceItem-edit");
