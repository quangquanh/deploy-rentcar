...
@section('content')
        ...
        <div class="table-wrapper">
            <div class="table-header justify-content-end">
                <div class="table-btn-area">
                    <a href="#galleryItem-add" class="btn--base modal-btn"><i class="fas fa-plus me-1"></i> {{ __("Add Gallery Item") }}</a>
                </div>
            </div>
    ...
    @include('admin.components.modals.site-section.add-gallery-item')

    {{-- Gallery Item Edit Modal --}}
    <div id="galleryItem-edit" class="mfp-hide large">
...
@push('script')
    ...
    <script>
        openModalWhenError("galleryItem-add","#galleryItem-add");
        openModalWhenError("galleryItem-edit","#galleryItem-edit");
        ...
        $(".edit-modal-button").click(function(){
            ...
            var editModal = $("#galleryItem-edit");
            ...
            fileHolderPreviewReInit("#galleryItem-edit input[name=image]");
            openModalBySelector("#galleryItem-edit");
