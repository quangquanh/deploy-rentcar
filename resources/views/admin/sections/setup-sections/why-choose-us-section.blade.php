...
@section('content')
        ...
        <div class="table-wrapper">
            <div class="table-header justify-content-end">
                <div class="table-btn-area">
                    <a href="#whyChooseItem-add" class="btn--base modal-btn"><i class="fas fa-plus me-1"></i> {{ __("Add Why Choose Us Item") }}</a>
                </div>
            </div>
                    ...
                    <tbody>
                        @forelse ($data->value->items ?? [] as $key => $item)
                            <tr data-item="{{ json_encode($item) }}">
                                ...
                                <td>{{textLength(strip_tags($item->language->$system_default_lang->item_description,10))  }}</td>
                                <td>
    ...
    @include('admin.components.modals.site-section.add-why-choose-us-item')

    {{-- Why Choose us Item Edit Modal --}}
    <div id="whyChooseItem-edit" class="mfp-hide large">
...
<script>
    openModalWhenError("whyChooseItem-add","#whyChooseItem-add");
    openModalWhenError("whyChooseItem-edit","#whyChooseItem-edit");
    ...
    $(".edit-modal-button").click(function(){
        ...
        var editModal = $("#whyChooseItem-edit");
        ...
        openModalBySelector("#whyChooseItem-edit");
