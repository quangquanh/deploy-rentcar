...
@section('content')
        ...
        <div class="table-wrapper">
            <div class="table-header justify-content-end">
                <div class="table-btn-area">
                    <a href="#videoItem-add" class="btn--base modal-btn"><i class="fas fa-plus me-1"></i> {{ __("Add Video Item") }}</a>
                </div>
            </div>
    ...
    @include('admin.components.modals.site-section.add-video-item')

    {{-- Video Item Edit Modal --}}
    <div id="videoItem-edit" class="mfp-hide large">
                                    ...
                                    <div class="tab-pane @if (get_default_language_code() == $item->code) fade show active @endif" id="edit-modal-{{ $item->name }}" role="tabpanel" aria-labelledby="edit-modal-{{$item->name}}-tab">
                                        ...
                                        <div class="form-group">
                                            @include('admin.components.form.input',[
                                                ...
                                                'value'     => old($lang_code . "_item_link_edit",
...
@push('script')
    ...
    <script>
        openModalWhenError("videoItem-add","#videoItem-add");
        openModalWhenError("videoItem-edit","#videoItem-edit");
        ...
        $(".edit-modal-button").click(function(){
            ...
            $.each(languages,function(index,item) {
                ...
                editModal.find("input[name="+item.code+"_item_link_edit]").val(oldData.language[item.code]?.item_link);
            ...
            fileHolderPreviewReInit("#videoItem-edit input[name=image]");
            openModalBySelector("#videoItem-edit");
